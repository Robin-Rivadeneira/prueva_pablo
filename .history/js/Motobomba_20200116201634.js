class Motobomba {
    ...
    toString() {
        if (this.estado == true) {
            ...
            document.body.appendChild(parrafo)
            moto.prender()
            var boton=document.getElementById("boton").value="apagdo"
        }
    }
    guardar(){
        ...
        document.getElementById('pintar').innerHTML='<button type="button"  value="Estado" id="boton" onclick="moto.toString()">ESTADO</button>'
    }
}
