class Motobomba {
    ...
    toString() {
        if (this.estado == true) {
            ...
            document.body.appendChild(parrafo)
            moto.prender()
            var boton=document.getElementById("estado").value="apagdo"
        }
    }
    guardar(){
        ...
        document.getElementById('pintar').innerHTML='<button type="button"  value="estado" id="estado" onclick="moto.toString()"></button>'
    }
}
