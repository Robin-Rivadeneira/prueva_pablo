class Motobomba {
    ...
    toString() {
        ...
        if (this.estado == true) {
            ...
            moto.apagar()
            document.getElementById('estado').textContent="apagar"
    ...
    guardar(){
        ...
        document.getElementById('pintar').innerHTML='<button type="button" id="estado" onclick="moto.toString()">Prender</button>'
    }
}
